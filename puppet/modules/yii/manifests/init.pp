class yii ($db_root_pw) {
  ...
  File {
    ...
    "/var/www/yii/1.1.13/demos/blog/protected/runtime":
      owner => www-data,
      group => www-data,
      require => Git::Clone["yii 1.1.13"];
    "/var/www/yii/1.1.13/demos/blog/assets":
      owner => www-data,
      group => www-data,
      require => Git::Clone["yii 1.1.13"];
    "/var/www/yii/1.1.13/demos/blog/protected/data/blog.db":
      owner => www-data,
      group => www-data,
      require => Git::Clone["yii 1.1.13"];
  }
  ...
  $demos_root="/var/www/yii/1.1.13/demos"
  Apache2::Vhost {
